    ...
    return (
        <div className={`${styles.flexBetween} w-full  navbar`}>
            ...
            <ul className="list-none sm:flex hidden justify-end   ">
                {navigationLinks?.map((item, index) => (
                    <li key={item.id}>
                        <a
                            href={`#${item.id}`}
                            className={`${styles.navLink} ${index === navigationLinks.length - 1 ? "mr-3" : "mr-10"
            ...
            <div className="sm:hidden flex flex-1 justify-end items-end">
                ...
                >
                    <ul className="list-none flex justify-center gap-7 items-center flex-1 ">
                        {navigationLinks.map((item, index) => (
                            <li key={item.id}>
                                <a
                                    href={`#${item.id}`}
                                    className={`${styles.navLink} ${index === navigationLinks.length - 1 ? "mr-0" : "mr-10"
